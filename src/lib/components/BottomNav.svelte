<script>
  ...
  const allTabs = [
    ...
    { id: 'scan',    label: 'Scan',      icon: 'M3 7h3l2-2h8l2 2h3v12H3zM12 13a3.5 3.5 0 100 0.01', requiresScan: true },
  ...
  let tabs = $derived(allTabs.filter((t) => !t.requiresScan || hasScan() || isNative()));
</script>
